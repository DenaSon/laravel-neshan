...
اگر قصد داری لوگو، نمونه خروجی یا اسکرین‌شات اضافه کنی، می‌تونم بخش‌های جداگانه‌ای هم بهش اضافه کنم (مثلاً بخش گالری یا پیش‌نمایش). همین‌طور اگر قصد انتشار در Packagist رو داری، عنوان و تگ‌ها رو هم می‌تونم برایت بهینه کنم.
```
