...
یک پکیج برای اتصال به [API نقشه ایستای نشان](https://developers.neshan.org/api/static) در فریم‌ورک Laravel.  
به‌راحتی از سرویس‌های نقشه نشان در پروژه‌های لاراول خود استفاده کنید.
